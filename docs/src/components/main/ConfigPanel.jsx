...
export default function ConfigPanel({functionsAndUseStates}) {
	...
	const SECTION_OVERRIDE_FIELDS = [
		...
		{ key: "score", label: "RMP score", errorMessage: "Expected like 1.1",
			validate: (value) => validInput5(value, /^\d+$/, 1, 1, ".")},
		{ key: "num_reviews", label: "Number of RMP reviews", errormessage: 
			"Expected any natrual number", validate: (value) => validInput2(value, 
																			/^\d+$/)
		}
	];
	...
	return (
		<div className="config-panel">
			...
			<div className="config-scroll-panel">
				...
				<section className="config-section">
					...
					{isBasicMode === "Advanced Mode" && (
						...
						<ToggleFieldList
							...
							onTouch={onTouch}
							onUntouch={onUntouch}
							validateAdd={(value) => validCourse(value)}
							nested={{
								...
								validateAdd: (value) => validSection(value),
								nested: {
									label: "Classes",
									...
									validateAdd: (value) => validClass(value),
									...
									nested: {
										...
										validateAdd: (value) => validSession(value),
										nested: null
									}
								}
							}}
				...
				<section className="config-section">
					<div className="config-divider"/>
					<p className="config-heading">Objectives</p>
					{isBasicMode === "Advanced Mode" && (
						<>
